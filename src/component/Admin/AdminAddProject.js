...
import { UsePostProject } from '../../Hooks/ProjectsHooks'
import  { Toaster } from 'react-hot-toast';


const AdminAddProject = () => {
    const [img,setName,setSelectedFile,setImg,setDescription,onImageChange,handelPost,response, GetLoading]=UsePostProject()
